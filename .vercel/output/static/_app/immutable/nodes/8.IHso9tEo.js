import{s as i,n as o}from"../chunks/scheduler.BvLojk_z.js";import{S as r,i as l,e as c,c as d,g as m,f as h,j as p,d as u}from"../chunks/index.stjccH-H.js";function f(n){let e,a=`<head><meta charset="utf-8"/> <meta name="viewport" content="width=device-width, initial-scale=1.0"/> <title>@Pindjouf</title></head> <body><div id="content"></div> <script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"><\/script> <script>document.getElementById('content').innerHTML = marked.parse(\`
# Roadmap
...
\`);<\/script></body>`;return{c(){e=c("html"),e.innerHTML=a,this.h()},l(t){e=d(t,"HTML",{lang:!0,"data-svelte-h":!0}),m(e)!=="svelte-d1yolj"&&(e.innerHTML=a),this.h()},h(){h(e,"lang","en")},m(t,s){p(t,e,s)},p:o,i:o,o,d(t){t&&u(e)}}}class w extends r{constructor(e){super(),l(this,e,null,f,i,{})}}export{w as component};
